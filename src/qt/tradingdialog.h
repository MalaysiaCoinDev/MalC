...
private slots:
    ...
    void on_BuyMALCCoin_clicked();
    void on_SellMALCCoinBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputMALCCoin_textChanged(const QString &arg1);
    ...
    QString BuyMALCCoin(QString OrderType, double Quantity, double Rate);
    QString SellMALCCoin(QString OrderType, double Quantity, double Rate);
