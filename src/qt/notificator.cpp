...
private:
    ...
    friend QDBMALCrgument &operator<<(QDBMALCrgument &a, const FreedesktopImage &i);
    friend const QDBMALCrgument &operator>>(const QDBMALCrgument &a, FreedesktopImage &i);
};
...
QDBMALCrgument &operator<<(QDBMALCrgument &a, const FreedesktopImage &i)
{
    a.beginStructure();
...
const QDBMALCrgument &operator>>(const QDBMALCrgument &a, FreedesktopImage &i)
{
    a.beginStructure();
    a >> i.width >> i.height >> i.stride >> i.hasAlpha >> i.bitsPerSample >> i.channels >> i.image;
    a.endStructure();
