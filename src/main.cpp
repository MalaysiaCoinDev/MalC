...
unsigned int nTargetSpacing = 1 * 30; // MALCCoin - 0.5 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // MALCCoin - time to elapse before new modifier is computed
...
const string strMessageMagic = "MALCCoin Signed Message:\n";
                        ...
                        bool* pfMissingInputs)
{
    ...
    if (fCheckInputs)
    {
        ...
        // This mitigates 'penny-flooding' -- sending thoMALCnds of free transactions just to
        ...
        if (nFees < MIN_RELAY_TX_FEE)
        {
...

            {
                ...
                nLastTime = nNow;
                // -limitfreerelay unit is thoMALCnd-bytes-per-minute
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MALCCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "https://www.coindesk.com/trump-white-house-doubles-us-commitment-blockchain/";
        CTransaction txNew;
        txNew.nTime = 1506629841;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1506629841;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 19037545;
        ...
        assert(block.hashMerkleRoot == uint256("0x65e2acc2cfe8a055944a34fc3addb92642da63a9e4eb47b1d833ef96352319ce"));
