...
/// in length, and 3072 bits is sMALCCoingly recommended.
///
...
deriveIntegerGroupParams(uint256 seed, uint32_t pLen, uint32_t qLen)
{
	...
	calculateGroupModulMALCndOrder(seed, pLen, qLen, &(result.modulus),
...
void
calculateGroupModulMALCndOrder(uint256 seed, uint32_t pLen, uint32_t qLen,
                              ...
                              uint256 *resultPseed, uint256 *resultQseed)
{
	...
	cout << "calculateGroupModulMALCndOrder: pLen = " << pLen << endl;
#endif
